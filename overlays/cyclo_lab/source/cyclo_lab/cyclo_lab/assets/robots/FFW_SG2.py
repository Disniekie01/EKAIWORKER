...
FFW_SG2_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "gripper_master": ImplicitActuatorCfg(
            ...
            # High stiffness + effort so the box weight cannot pry the fingers
            # open while holding/lifting.
        ...
        "gripper_slave": ImplicitActuatorCfg(
            ...
            # The slave finger links are the actual gripping surfaces. They must
            # also hold firm so the box load can't force them open/deform.
            effort_limit_sim=120.0,
            stiffness=1500.0,
            damping=8.0,
        ),

...
from cyclo_lab.assets.object.thick_cardboard_box import BOX_HALF_HEIGHT
...
def randomize_l_table_scene(
    ...
    """Place the two prim tables in an L formation and spawn the thick box on the front table."""
    if env_ids is None:
        return

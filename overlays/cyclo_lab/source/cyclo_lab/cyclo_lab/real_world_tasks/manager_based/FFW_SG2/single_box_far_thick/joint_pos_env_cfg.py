...
from cyclo_lab.real_world_tasks.manager_based.FFW_SG2.single_box_far_thick.single_box_far_thick_env_cfg import (
    SingleBoxFarThickEnvCfg,
)
...
class EventCfg:
    ...
    randomize_single_box_far_scene = EventTerm(
...
@configclass
class FFWSG2SingleBoxFarThickEnvCfg(SingleBoxFarThickEnvCfg):
    def __post_init__(self):
        ...
        # Use the full-leg table for the rear so it isn't missing a leg
        # (TABLE_FRONT_CFG hides one leg to give the robot foot clearance).

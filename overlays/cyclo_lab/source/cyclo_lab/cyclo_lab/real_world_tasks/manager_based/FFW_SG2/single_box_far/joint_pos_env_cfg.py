...
from cyclo_lab.real_world_tasks.manager_based.FFW_SG2.single_box_far.single_box_far_env_cfg import SingleBoxFarEnvCfg
...
@configclass
class FFWSG2SingleBoxFarEnvCfg(SingleBoxFarEnvCfg):

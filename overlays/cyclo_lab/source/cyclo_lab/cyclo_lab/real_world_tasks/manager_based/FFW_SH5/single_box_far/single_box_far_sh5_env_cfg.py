...
from isaaclab.controllers.differential_ik_cfg import DifferentialIKControllerCfg
from isaaclab.envs.mdp.actions.actions_cfg import DifferentialInverseKinematicsActionCfg
from cyclo_lab.real_world_tasks.manager_based.FFW_SG2.single_box_far.mdp.single_box_far_events import (
    REAR_TABLE_DISTANCE_M,
)


@configclass
class SingleBoxFarSceneCfg(InteractiveSceneCfg):
    """Front pick table + rear place table 3 m behind the robot."""
...
@configclass
class SingleBoxFarSH5EnvCfg(ManagerBasedRLEnvCfg):
    """Thin box pick from front table and place on a rear table 3 m behind the robot."""

    scene: SingleBoxFarSceneCfg = SingleBoxFarSceneCfg(
        num_envs=4096,
